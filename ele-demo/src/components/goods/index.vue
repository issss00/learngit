<template>
  <div>
    <el-button @click="$router.push('/goods/add')">添加</el-button>
...
export default {
  ...
  mounted() {
    axios.get("/api/goodslist", { params: { istree: true } }).then((res) => {
  ...
  methods: {
    del(obj) {
      this.$confirm("此操作将永久删除该商品, 是否继续?", "提示", {
        ...
        axios.post("/api/goodsdelete", { id: obj.row.id }).then((res) => {
